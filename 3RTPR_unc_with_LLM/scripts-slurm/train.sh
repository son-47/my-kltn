...
# #base + Uncertainty + LLM
for seed in 123 456 4477 ; do
  # python run.py  --cfg config_model.yml --seed $seed \
  #   --d-names CUHK-PEDES -n hihi  --l-names sdm  --bs 128 --saug-text --erpi 0.5 --erpt 0.2 \
  #   --ccd --ccd-tiebreak sim --ldynamic  --ldynamic-t 6 --ldynamic-m min --lossweight-sdm 1 --sratio 0.4 --fusedim 5120 \
  #   --uncertainty --uncertainty-tau 1 --uncertainty-alpha 0.5 --use_augmented --aug_ratio 0.2 --annotation_dir ./datasets/annotation/annotation --train_annotation_source dir  --eval_annotation_source raw 
  ...
  python run.py  --cfg config_model.yml --seed $seed \
    --d-names CUHK-PEDES -n hihi  --l-names sdm  --bs 128 --saug-text --erpi 0.5 --erpt 0.2 \
    --ccd --ccd-tiebreak sim --ldynamic  --ldynamic-t 6 --ldynamic-m min --lossweight-sdm 1 --sratio 0.4 --fusedim 5120 \
    --uncertainty --uncertainty-tau 1 --uncertainty-alpha 0.5
  # python run.py  --cfg config_model.yml --seed $seed \
  #   --d-names ICFG-PEDES -n hihi  --l-names sdm  --bs 128 --saug-text --erpi 0.5 --erpt 0.2 \
  #   --ccd --ccd-tiebreak sim --ldynamic  --ldynamic-t 6 --ldynamic-m min --lossweight-sdm 1 --sratio 0.4 --fusedim 5120 \
  #   --uncertainty --uncertainty-tau 1 --uncertainty-alpha 0.5 --use_augmented --aug_ratio 0.2 --annotation_dir ./datasets/annotation/annotation

  # python run.py  --cfg config_model.yml --seed $seed \
  #   --d-names RSTPReid -n hihi  --l-names sdm  --bs 128 --saug-text --erpi 0.5 --erpt 0.2 \
  #   --ccd --ccd-tiebreak sim --ldynamic  --ldynamic-t 6 --ldynamic-m min --lossweight-sdm 1 --sratio 0.4 --fusedim 5120 \
  #   --uncertainty --uncertainty-tau 1 --uncertainty-alpha 0.5 --use_augmented --aug_ratio 0.2 --annotation_dir ./datasets/annotation/annotation
