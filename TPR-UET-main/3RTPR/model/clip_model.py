...
class CLIP(nn.Module):
    ...
    def forward(self, image, text):
        image_features,atten_i, image_rfeatures = self.encode_image(image)
        text_features,atten_t, text_rfeatures = self.encode_text(text)
        ...
        return image_features, text_features, atten_i, atten_t, image_rfeatures, text_rfeatures
